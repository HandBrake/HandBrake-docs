...
Activity logs explain a lot and are **required** for all support requests. More information about [Activity Logs] (TODO: link).
...
Real-time chat is available on our [Freenode](http://freenode.net/irc_servers.shtml) IRC channel, [#handbrake](irc://irc.freenode.net/#handbrake). Make sure to provide an [Activity Log] (TODO: link) when requesting support.
